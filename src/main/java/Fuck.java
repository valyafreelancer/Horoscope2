...
public class Fuck {
    public static void main(String[] args) {
        String[] zodiacs = {"Овен", "Телец", "Близнецы", "Рак", "Лев", "Дева", "Весы", "Скорпион", "Стрелец", "Козерог", "Водолей", "Рыбы"};
        ...
        int a = runForExample(String[] zodiacs);
        System.out.println(" Ваш гороскоп на сегодня" + a);

    }

    public static void runForExample(String[] zodiacs) {
        for (int i = 1; i < zodiacs.length; i++) {
            String b = zodiacs[i];
            System.out.println("Ваш знак зодиака: " + b);
